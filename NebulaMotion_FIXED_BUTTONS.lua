...
AnimationSystem.ResetRandomSlot = function(frontFrame)
    ...
    if slot and slot:IsA("ImageLabel") then
        slot.ImageColor3 = Color3.fromRGB(240, 240, 255)
        slot.Image = ""
...
ToggleBtn.Text = "EMOTES MENU"
ToggleBtn.TextColor3 = Color3.fromRGB(255,255,255)
ToggleBtn.TextSize = 14
ToggleBtn.Font = Enum.Font.GothamBoldBold
...
StretchToggle.Parent = ToggleContainer
StretchToggle.BackgroundColor3 = Color3.fromRGB(15,15,15)
StretchToggle.BackgroundTransparency = 0.15
StretchToggle.Position = UDim2.new(0, 138, 1, -52)
StretchToggle.Size = UDim2.fromOffset(80, 42)
StretchToggle.Text = "STRETCH"
StretchToggle.TextColor3 = Color3.fromRGB(255,255,255)
StretchToggle.Font = Enum.Font.GothamBoldBold
StretchToggle.TextSize = 12

local StretchCorner = Instance.new("UICorner")
StretchCorner.CornerRadius = UDim.new(0,10)
StretchCorner.Parent = StretchToggle

local function ApplyModernStyle(obj)
    pcall(function()
        obj.BackgroundColor3 = Color3.fromRGB(18,18,18)

        if not obj:FindFirstChild("ModernCorner") then
        ...
        if not obj:FindFirstChild("ModernStroke") then
...
task.spawn(function()
    repeat task.wait() until getSettingsMainFrame()

    local MainFrame = getSettingsMainFrame()

    if MainFrame then
        ApplyModernStyle(MainFrame)

        MainFrame.ClipsDescendants = true

        local Scale = Instance.new("UIScale")
        Scale.Name = "ModernScale"
...
function applySettingsToggleStyle()
    ...
    if bgColor then
        ToggleBtn.BackgroundColor3 = bgColor    end
end
...
function CreatePopup(title, size)
    ...
    lbl.Font = Enum.Font.GothamBoldBold
    lbl.TextSize = 13
...
function CreateButton(parent, text, color, pos, size)
    ...
    btn.Text = text
    btn.Font = Enum.Font.GothamBoldBold
...
SettingsLib.AddIconButton(BtnRow, "78317476576895", function()
    ...
    close.Text = "×"
    close.Font = Enum.Font.GothamBoldBold
    close.TextSize = 20
...
BackupTitle.Font = Enum.Font.GothamBoldBold
...
function createGUIElements()
    ...
    UI.Search.Text = ""
    UI.Search.TextColor3 = Color3.fromRGB(240, 240, 255)
    ...
    UI.SpeedBox.Text = "1"
    UI.SpeedBox.TextColor3 = Color3.fromRGB(240, 240, 255)
...
function setupElementDragging(name, element, allMovable, snapGuideV, snapGuideH)
    ...
    table.insert(HUD.Connections, inputTarget.InputBegan:Connect(function(input)
        ...
        if input.UserInputType == Enum.UserInputType.MouseButton1 or input.UserInputType == Enum.UserInputType.Touch then
            ...
            stroke.Color = Color3.fromRGB(240, 240, 255)
...
enterHUDEditor = function()
    ...
    local function createPropRow(label, lOrder, isLarge)
        ...
        tbox.TextColor3 = Color3.fromRGB(240, 240, 255)
    ...
    deleteBtn.TextColor3 = Color3.fromRGB(240, 240, 255)
    deleteBtn.Font = Enum.Font.GothamBoldBold
...
--// Modern Navigation Buttons Fix
task.spawn(function()
    task.wait(1)

    local MainFrame = CoreGui:FindFirstChild("NebulaMotionUI", true)
    if not MainFrame then return end

    local NavBar = Instance.new("Frame")
    NavBar.Name = "ModernNav"
    NavBar.Size = UDim2.new(1, -20, 0, 50)
    NavBar.Position = UDim2.new(0, 10, 0, 10)
    NavBar.BackgroundColor3 = Color3.fromRGB(20,20,35)
    ...
    local function makeButton(txt)
        ...
        b.BackgroundColor3 = Color3.fromRGB(90,60,255)
        b.Text = txt
